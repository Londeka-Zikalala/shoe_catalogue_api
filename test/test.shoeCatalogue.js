...
describe('shoeCatalogue function', function () {
    ...
    it('should fetch all shoes from the database', async function () {
        ...
        await shoeService.addShoe(shoeColor2,shoeBrand2, price2, size2, available2, img2);
        await shoeService.addShoe(shoeColor3,shoeBrand3, price3, size3, available3, img3);
